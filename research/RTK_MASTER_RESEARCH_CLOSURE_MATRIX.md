...
| D5 | Autonomous decision-tree regression coverage | 🚀 MAJOR CLOSED | Workflow success is separated from scientific classification. The `t=1.1` base→half router dispatches half only after a persisted recenter-clear PD base; recenter or non-PD states stop safely. The half target was preregistered before base scores. |
