...
"""
import copy
import rtk.enforce_stage4d3_multiscale_gate as G
...
# 1) A non-PD recenter-clear base must request the eigenray gate, not half-stencil.
...
# 2) A completed exact-ray result with no >tol downhill clears the ray gate.
...
# 3) A completed exact-ray result with >tol downhill must recenter and restart axis.
