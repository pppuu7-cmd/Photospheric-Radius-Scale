...
# Wider diagnostic polls first, then fine polls.  Each finer poll recenters on
# the best exact point found by the previous poll.
...
summary={
 ...
 'memoization_key':'exact_float_normalized_coordinates','failure_policy':'one_retry_for_CLASS_TIMEOUT_then_constant_penalty',
